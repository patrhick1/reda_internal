-- list_stock_movements as live on the box, captured 2026-09-09 before the product filter
-- and running balance were added (supabase/migrations/20260909120000_stock_history_product_filter.sql).
-- The tracked copy had drifted (an older CTE-based body); this is the real one.
