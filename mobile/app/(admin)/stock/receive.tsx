...
// One product/qty line on the receive form. Each row enqueues an independent
...
export default function ReceiveStock() {
  ...
  // Auto-select the only active warehouse if there's exactly one (current case).
  useEffect(() => {
