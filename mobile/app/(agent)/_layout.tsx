...
import { AgentUnreadProvider, useAgentUnreadMessagesData } from '@/hooks/useAgentUnreadMessages';
  ...
  return (
    <AgentUnreadProvider value={unread}>
      ...
      >
        ...
        <Tabs.Screen name="count" options={{ href: null }} />
        <Tabs.Screen name="count-history" options={{ href: null }} />
      </Tabs>
    </AgentUnreadProvider>
  );
}
