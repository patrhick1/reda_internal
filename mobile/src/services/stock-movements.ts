...
import {
  ...
  type MovementPeriod,
  type MovementSummaryReason,
  type MovementSummaryRow,
} from './stock-movement-summary';

export { groupMovementSummary };
export type { MovementPeriod, MovementSummaryRow };
...
export type MovementEventKind = MovementSummaryReason;
