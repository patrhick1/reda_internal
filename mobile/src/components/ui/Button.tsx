...
const VARIANT_STYLES: Record<ButtonVariant, { bg: string; fg: string; borderColor?: string; borderWidth?: number }> = {
...
export function Button({
  children, title, variant = 'primary', size = 'md',
  icon, iconRight, full, disabled, onPress, style, accessibilityLabel,
}: ButtonProps) {
