...
export type IconName =
  | 'home' | 'package' | 'truck' | 'wallet' | 'user' | 'users'
  | 'phone' | 'mapPin' | 'chevronRight' | 'chevronLeft' | 'chevronDown'
  | 'plus' | 'check' | 'x' | 'alert' | 'bell' | 'search' | 'filter'
  | 'refresh' | 'settings' | 'file' | 'calendar' | 'warehouse'
  | 'arrowRight' | 'arrowDown' | 'arrowUp' | 'cash' | 'bank' | 'history'
  | 'bot' | 'eye' | 'eyeOff' | 'lock' | 'box' | 'moreVertical' | 'edit' | 'sliders' | 'logout' | 'share' | 'helpCircle'
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  alert:       <><Path d="M12 8v5"/><Circle cx="12" cy="16.5" r={0.5}/><Path d="m12 2 10 18H2z"/></>,
  ...
  eyeOff:      <><Path d="M3 3l18 18"/><Path d="M10.5 6.2A10 10 0 0 1 12 6c6 0 10 6 10 6a17.9 17.9 0 0 1-3.2 4M6.6 6.6A17.9 17.9 0 0 0 2 12s4 6 10 6a10 10 0 0 0 4.4-1"/><Path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/></>,
  ...
  helpCircle:  <><Circle cx="12" cy="12" r="10"/><Path d="M9.5 9a2.5 2.5 0 0 1 5 0c0 1.7-2.5 2.5-2.5 4"/><Circle cx="12" cy="17" r={0.5}/></>,
  mic:         <><Rect x="9" y="2" width="6" height="12" rx="3"/><Path d="M5 11a7 7 0 0 0 14 0M12 19v3M8 22h8"/></>,
  micOff:      <><Path d="M3 3l18 18"/><Path d="M9 9v2a3 3 0 0 0 5.1 2.1M15 11V5a3 3 0 0 0-5.9-.7"/><Path d="M5 11a7 7 0 0 0 11.6 5.3M19 11a7 7 0 0 1-1.6 4.4"/><Path d="M12 19v3M8 22h8"/></>,
  volume2:     <><Path d="M11 5 6 9H3v6h3l5 4z"/><Path d="M16 8a5 5 0 0 1 0 8M19 5a9 9 0 0 1 0 14"/></>,
  phoneOff:    <><Path d="M22 17.5a2 2 0 0 1-2 2 16 16 0 0 1-7-1.7M3.4 11.4A16 16 0 0 1 2 6.5a2 2 0 0 1 2-2h4l2 5-2.5 1.5"/><Path d="M3 3l18 18"/></>,
